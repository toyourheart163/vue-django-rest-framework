    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.URLField(default='https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif', verbose_name='头像')),
                ('introduction', models.CharField(default='还没来得及介绍。。', max_length=200, verbose_name='介绍')),
